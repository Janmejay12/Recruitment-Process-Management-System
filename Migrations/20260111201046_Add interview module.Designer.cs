...
namespace Recruitment_System.Migrations
{
    ...
    [Migration("20260111201046_Add interview module")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recruitment_System.Entities.InterviewFeedback", b =>
                {
                    ...
                    b.HasIndex("InterviewRoundId", "InterviewerUserId")
                        .IsUnique();

                    b.ToTable("InterviewFeedbacks");
                });

            modelBuilder.Entity("Recruitment_System.Entities.InterviewPanelMember", b =>
                {
            ...
            modelBuilder.Entity("Recruitment_System.Entities.InterviewProcess", b =>
                {
                    b.Property<int>("InterviewProcessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InterviewProcessId"));
            ...
            modelBuilder.Entity("Recruitment_System.Entities.InterviewRound", b =>
                {
                    b.Property<int>("InterviewRoundId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InterviewProcessId", "RoundNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("Recruitment_System.Entities.InterviewFeedback", b =>
                {
                    b.HasOne("Recruitment_System.Entities.InterviewRound", "InterviewRound")
                        .WithMany("Feedbacks")
                        .HasForeignKey("InterviewRoundId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Recruitment_System.Entities.User", "Interviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("Recruitment_System.Entities.InterviewRound", b =>
                {
                    b.HasOne("Recruitment_System.Entities.InterviewProcess", "InterviewProcess")
                        .WithMany("Rounds")
